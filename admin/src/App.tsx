...
import AddEnglishMovie from "./pages/addEnglishmovie";
import AddBanglaMovie from "./pages/addbanglamovie";
import AddHindiMovie from "./pages/addHindimovie";
        ...
        <>
          ...
          <div className="divied">
            ...
            <Routes>
              ...
              />
              <Route
                path="/add-english-movie"
                element={<AddEnglishMovie token={token} />}
              />
              <Route
                path="/add-bangla-movie"
                element={<AddBanglaMovie token={token} />}
              />
              <Route
                path="/add-hindi-movie"
                element={<AddHindiMovie token={token} />}
              />
              <Route
                path="/add-other-movie"
                element={<AddOtherMovie token={token} />}
              />
              <Route
